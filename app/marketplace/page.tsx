          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-3 gap-8 max-w-md mx-auto">
              <div className="text-center">
                <div className="text-3xl font-bold text-green-400 dark:text-yellow-400">{vehicles.length}+</div>
                <div className="text-sm text-muted-foreground">Premium Vehicles</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-green-400 dark:text-yellow-400">50+</div>
                <div className="text-sm text-muted-foreground">Verified Dealers</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-green-400 dark:text-yellow-400">4.9</div>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className={cn(
                ...
                viewMode === 'grid' ? "bg-yellow-400 text-black border-yellow-400" : "border-border hover:border-yellow-400"
              )}
            >
            ...
            <button
              ...
              className={cn(
                "h-10 w-10 rounded-md flex items-center justify-center border transition-colors",
                viewMode === 'list' ? "bg-yellow-400 text-black border-yellow-400" : "border-border hover:border-yellow-400"
              )}
            >
                  ...
                  {popularMakes.map((make) => (
                    <button
                      ...
                      className={cn(
                        ...
                        selectedMakes.includes(make) ? "bg-yellow-400 text-black border-yellow-400" : "border-border hover:border-yellow-400"
                      )}
                    >
                      {make}
                    </button>
