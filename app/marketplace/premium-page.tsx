...
function PremiumVehicleCard({ vehicle, viewMode = 'grid' }: { vehicle: any, viewMode?: 'grid' | 'list' }) {
        ...
        <div className="flex">
          <div className="relative w-80 h-56 overflow-hidden">
            ...
            <div className="absolute top-4 left-4 flex gap-2 z-20">
              {vehicle.isFeatured && (
                <Badge className="bg-jaba-red text-white border-0 shadow-lg">
                  <Star className="w-3 h-3 mr-1 fill-current" />
                  Featured
                </Badge>
              )}
              {vehicle.isNew && (
                <Badge className="bg-jaba-gold text-black border-0 shadow-lg font-semibold">
                  New
                </Badge>
              )}
            </div>
            ...
            <Button
              ...
              className="absolute top-4 right-4 h-10 w-10 rounded-full bg-background/80 backdrop-blur hover:bg-jaba-gold/20 border-0 z-20"
            >
          ...
          <div className="flex-1 p-6 flex flex-col justify-between">
            ...
            <div className="flex items-center justify-between pt-4 border-t border-border">
              ...
              <div className="flex gap-2">
                <Button variant="outline" size="sm" className="border-jaba-gold text-jaba-gold hover:bg-jaba-gold hover:text-black">
                  <Calendar className="w-4 h-4 mr-1" />
                  Schedule Test Drive
                </Button>
                <Link href={`/vehicles/${vehicle.id}`}>
                  <Button size="sm" className="bg-gradient-to-r from-jaba-gold to-jaba-gold-light text-black hover:from-jaba-gold-dark hover:to-jaba-gold font-semibold">
                    View Details
  ...
  // Grid view
  return (
    <Card className="group overflow-hidden hover:shadow-2xl transition-all duration-500 border-0 bg-card/50 backdrop-blur-sm hover:bg-card/80">
      <div className="relative overflow-hidden">
        <div className="aspect-video relative">
          ...
          <Button
            ...
            size="sm"
            onClick={() => setIsFavorited(!isFavorited)}
            className="absolute top-4 right-4 h-9 w-9 rounded-full bg-background/80 backdrop-blur hover:bg-jaba-gold/20 border-0 z-20"
          >
            <Heart className={cn("w-4 h-4", isFavorited && "fill-jaba-red text-jaba-red")} />
          </Button>
          ...
          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-20">
            <Button size="sm" className="bg-background/90 text-foreground hover:bg-jaba-gold hover:text-black backdrop-blur">
        ...
        <div className="container mx-auto px-4 py-16 relative">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center mb-6">
              <Badge className="bg-jaba-gold/10 text-jaba-gold border-jaba-gold/20 px-4 py-2">
            ...
            <div className="relative max-w-2xl mx-auto mb-8">
              ...
              <Input
                ...
                className="pl-12 pr-4 py-4 text-lg border-2 border-border focus:border-jaba-gold rounded-2xl bg-card/50 backdrop-blur"
              />
            </div>
      ...
      <div className="container mx-auto px-4 py-8">
              ...
              <Button
                ...
                className={cn(
                  ...
                  activeCategory === category.id
                    ? "bg-jaba-gold text-black hover:bg-jaba-gold-dark shadow-lg"
        ...
        <div className="flex flex-col lg:flex-row gap-6 mb-8">
          <div className="flex-1 flex flex-wrap items-center gap-4">
            <Button
              ...
              className="border-border hover:border-jaba-gold hover:text-jaba-gold"
            >
                  ...
                  <div className="flex flex-wrap gap-2">
                    {popularMakes.map((make) => (
                      <Button
                        ...
                        className={cn(
                          "text-xs",
                          selectedMakes.includes(make) && "bg-jaba-gold text-black"
                        )}
                      >
                        {make}
                      </Button>
        ...
        {!isLoading && filteredVehicles.length > 0 && filteredVehicles.length >= 20 && (
          <div className="text-center mt-12">
            <Button size="lg" variant="outline" className="border-jaba-gold text-jaba-gold hover:bg-jaba-gold hover:text-black">
              Load More Vehicles
