...
export default function DirectImportDetail() {
  ...
  useEffect(() => {
    ...
    // If Firestore is available, listen for realtime updates. Otherwise fall back to getListing
    if (db) {
    ...
    // If db not ready, use getListing once
    fetchVehicle();
    return () => {};
  }, [id]);
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-4">
        ...
        <div className="space-y-6">
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-muted-foreground mt-1">
                {vehicle.location || "Imported vehicle"}
              </p>
            </div>
          </div>

          <div className="text-2xl font-semibold">
            {vehicle.directImport === true ||
            (typeof vehicle.price === "string" &&
              ...
              ? typeof vehicle.price === "string"
                ...
                : `$${vehicle.price}`
              : `KES ${parseInt(
                  String(vehicle.price || "0").replace(/[^0-9.-]+/g, "") || "0"
                ).toLocaleString()}`}
          </div>
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  {vehicle.contactPhone || "No phone provided"}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <a
              href={`https://wa.me/${(vehicle.contactPhone || "").replace(
                /\D/g,
                ""
              )}`}
              target="_blank"
