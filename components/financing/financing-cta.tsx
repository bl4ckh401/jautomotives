      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="bg-[#242b33] border-gray-700 hover:border-blue-500 transition-all duration-300 hover:shadow-blue-500/20 hover:shadow-lg">
          <CardContent className="p-8 flex flex-col items-center text-center h-full">
            ...
            <p className="text-gray-300 mb-6">
              Complete our secure online application to get pre-approved for financing.
            </p>
        ...
        <Card className="bg-[#242b33] border-gray-700 hover:border-blue-500 transition-all duration-300 hover:shadow-blue-500/20 hover:shadow-lg">
          <CardContent className="p-8 flex flex-col items-center text-center h-full">
            ...
            <h3 className="text-xl font-semibold mb-3">Calculate Payments</h3>
            <p className="text-gray-300 mb-6">
              Use our loan calculator to estimate your monthly payments and total cost.
            </p>
        ...
        <Card className="bg-[#242b33] border-gray-700 hover:border-blue-500 transition-all duration-300 hover:shadow-blue-500/20 hover:shadow-lg">
          <CardContent className="p-8 flex flex-col items-center text-center h-full">
            ...
            <h3 className="text-xl font-semibold mb-3">Speak to an Expert</h3>
            <p className="text-gray-300 mb-6">Have questions? Our financing specialists are here to help you.</p>
